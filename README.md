...
このアプリは、ふたつの対話 — ゆうころと Claude — の中で少しずつかたちになっていきました。
ここにそのプロセスをひっそりと残しておきます。

| 日付 | 出来たこと |
|---|---|
| 2026-04-22 | はじまり。コンセプト固め、Phase 0〜3 を一気に実装 — Messengerインポート、SQLite、AI章分け、BYOK、円グラフ、お気に入り（⭐⭐︎💗）、木目調UI |
| 2026-04-22 | サンプルデータ（オルティスくん/リルムちゃん）、初回オンボーディング、スワイプ操作 |
| 2026-04-22 | Vercel に紹介ページをデプロイ（最初は実 Web 版、後に静的ランディングに切替） |
| 2026-06-15 | 本棚アイコン、スプラッシュ画像、Tip付きローディング画面 |
| 2026-06-16 | 木目テクスチャ画像、章の区切り線、本の背表紙色、タイトル編集、章詳細から戻った時のフォーカス再読込 |
| 2026-06-16 | 会話グラフに期間表示・AI感想3文、円グラフのカテゴリタップで絞り込み、ヘルプページとFacebook/Anthropic への外部リンク |

最新の開発状況は [GitHub の commit 履歴](https://github.com/ortiz-ai-partners/messagememory/commits/main) でも追えます。
